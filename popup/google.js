 ...
 * Original file: /npm/@google/generative-ai@0.22.0/dist/index.mjs
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function L(t,e,n,s){return w(await O(e,p.STREAM_GENERATE_CONTENT,t,!0,JSON.stringify(n),s))}async function x(t,e,n,s){const o=await O(e,p.GENERATE_CONTENT,t,!1,JSON.stringify(n),s);return{response:_(await o.json())}}
/**
 * @license
 * Copyright 2024 Google LLC
 *
